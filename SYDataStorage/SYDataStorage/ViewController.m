...
//    
//    [SYCacheManager sharedSYCacheManager].code = @"100";
//    [SYCacheManager sharedSYCacheManager].name = @"李四";
//    [SYCacheManager sharedSYCacheManager].isOk = NO;
//    [SYCacheManager sharedSYCacheManager].age = 0;
//    [SYCacheManager sharedSYCacheManager].weight = 92.15;
    NSLog(@"%zd----%zd----%f",[SYCacheManager sharedSYCacheManager].isOk,[SYCacheManager sharedSYCacheManager].age,[SYCacheManager sharedSYCacheManager].weight);
}
