//
//  RTHCoursesEvaluateViewController.m
//  SYSlideDemo
//
...
@interface RTHCoursesEvaluateViewController ()

@end

@implementation RTHCoursesEvaluateViewController
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.textLabel.text = [NSString stringWithFormat:@"评价-%ld",indexPath.row];
    return cell;
}
