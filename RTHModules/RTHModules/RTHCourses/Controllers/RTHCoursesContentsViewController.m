//
//  RTHCoursesContentsViewController.m
//  SYSlideDemo
//
...
@interface RTHCoursesContentsViewController ()

@end

@implementation RTHCoursesContentsViewController
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.textLabel.text = [NSString stringWithFormat:@"目录-%ld",indexPath.row];
    return cell;
}
